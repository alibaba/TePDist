...
class Var : public ResourceBase {
 public:
  ...
  string* mutable_initializer_string() { return &initializer_string_; }
  TensorShape* mutable_initializer_shape() { return &initializer_shape_; }
 ...
 private:
  mutex mu_;
  Tensor tensor_;
  string initializer_string_;
  TensorShape initializer_shape_;
