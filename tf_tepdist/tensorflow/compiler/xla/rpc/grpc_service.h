...
class GRPCService : public grpc::XlaService::Service {
 public:
  ...
  ::grpc::Status TransferToServerHost(::grpc::ServerContext* context,
                                  const TransferToServerRequest* arg,
                                  TransferToServerResponse* result) override;

  ::grpc::Status DoRemoteSave(::grpc::ServerContext* context,
                              const DoRemoteSaveRequest* arg,
                              DoRemoteSaveResponse* result) override;

  ::grpc::Status DoRemoteRestore(::grpc::ServerContext* context,
