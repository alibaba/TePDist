...
#ifndef TENSORFLOW_COMPILER_XLA_SERVICE_DAPPLE_ALL_REDUCE_COMBINER_H_
#define TENSORFLOW_COMPILER_XLA_SERVICE_DAPPLE_ALL_REDUCE_COMBINER_H_
...
class DAPPLEAllReduceCombiner : public HloModulePass {
 public:
  DAPPLEAllReduceCombiner(int64 combine_threshold_in_bytes,
                          int64 combine_threshold_count);

  absl::string_view name() const override {
    return "dapple=all-reduce-combiner";
  }
...
#endif  // TENSORFLOW_COMPILER_XLA_SERVICE_DAPPLE_ALL_REDUCE_COMBINER_H_
