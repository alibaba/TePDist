...
absl::string_view ThunkKindToString(Thunk::Kind kind) {
  switch (kind) {
    ...
    case Thunk::kDAPPLEAllReduce:
      return "kDAPPLEAllReduce";
    case Thunk::kDAPPLEAllGather:
      return "kDAPPLEAllGather";
    case Thunk::kDAPPLEAllToAll:
      return "kDAPPLEAllToAll";
    case Thunk::kFft:
      return "kFft";
    case Thunk::kGemm:
      return "kGemm";
