...
GpuExecutableRunOptions& GpuExecutableRunOptions::set_nccl_context(
    gpu::NcclContext* nccl_ctx) {
  nccl_ctx_ = nccl_ctx;
  return *this;
}

const gpu::NcclContext* GpuExecutableRunOptions::nccl_context() const {
  return nccl_ctx_;
}
