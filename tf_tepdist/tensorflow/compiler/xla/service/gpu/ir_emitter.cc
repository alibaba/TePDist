...
Status IrEmitter::HandleDAPPLEAllReduce(HloInstruction* crs) {
  return Unimplemented(
      "DAPPLEAllReduce cannot be nested inside of fusion, map, etc.");
}

Status IrEmitter::HandleDAPPLEAllToAll(HloInstruction* crs) {
  return Unimplemented(
      "DAPPLEAllToAll cannot be nested inside of fusion, map, etc.");
}
