...
class DfsHloVisitorBase {
 ...
 public:
  ...
  virtual Status HandleDAPPLEAllReduce(HloInstructionPtr hlo) = 0;
  virtual Status HandleDAPPLEAllToAll(HloInstructionPtr hlo) = 0;
  virtual Status HandleDAPPLEAllGather(HloInstructionPtr hlo) = 0;
  virtual Status HandleCustomCollective(HloInstructionPtr hlo) = 0;
