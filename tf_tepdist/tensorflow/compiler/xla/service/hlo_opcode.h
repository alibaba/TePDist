...
#define HLO_OPCODE_LIST(V)                                             \
  ...
  V(kDAPPLEAllReduce, "dapple-all-reduce", kHloOpcodeIsVariadic)       \
  V(kAllToAll, "all-to-all", kHloOpcodeIsVariadic)                     \
  V(kDAPPLEAllToAll, "dapple-all-to-all", kHloOpcodeIsVariadic)        \
  V(kDAPPLEAllGather, "dapple-all-gather", kHloOpcodeIsVariadic)       \
  V(kAtan2, "atan2", 2)                                                \
  ...
  V(kCustomCollective, "custom-collective", kHloOpcodeIsVariadic)      \
  V(kDivide, "divide", 2)                                              \
  V(kDomain, "domain", 1)                                              \
  V(kDot, "dot", 2)                                                    \
