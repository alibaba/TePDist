...
Status ShapeVerifier::HandleDAPPLEAllReduce(HloInstruction* crs) {
  return Status::OK();
}

Status ShapeVerifier::HandleDAPPLEAllToAll(HloInstruction* crs) {
  return Status::OK();
}

Status ShapeVerifier::HandleDAPPLEAllGather(HloInstruction* crs) {
  return Status::OK();
}

Status ShapeVerifier::HandleCustomCollective(HloInstruction* crs) {
  return Status::OK();
}
...
class InstructionVerifier : public DfsHloVisitorWithDefault {
 public:
  ...
  Status HandleDAPPLEAllReduce(HloInstruction* crs) override {
    return Status::OK();
  }
