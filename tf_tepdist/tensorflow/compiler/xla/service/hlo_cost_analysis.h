...
class HloCostAnalysis : public ConstDfsHloVisitor {
 public:
  ...
  Status HandleDAPPLEAllReduce(const HloInstruction* crs) override;
  Status HandleDAPPLEAllToAll(const HloInstruction* crs) override;
  Status HandleAllToAll(const HloInstruction* hlo) override;
  Status HandleDAPPLEAllGather(const HloInstruction* crs) override;
  Status HandleCustomCollective(const HloInstruction* crs) override;
