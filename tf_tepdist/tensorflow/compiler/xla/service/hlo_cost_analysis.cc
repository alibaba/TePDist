...
Status HloCostAnalysis::HandleDAPPLEAllReduce(const HloInstruction* crs) {
  return HandleAllReduce(crs);
}
...
// (TODO) Support dapple-all-to-all estimation
Status HloCostAnalysis::HandleDAPPLEAllToAll(const HloInstruction* hlo) {
  return Status::OK();
}
...
Status HloCostAnalysis::HandleDAPPLEAllGather(const HloInstruction* hlo) {
  return Status::OK();
}

Status HloCostAnalysis::HandleCustomCollective(const HloInstruction* hlo) {
  return Status::OK();
}
