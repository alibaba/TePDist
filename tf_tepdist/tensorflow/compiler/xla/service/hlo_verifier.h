...
class ShapeVerifier : public DfsHloVisitor {
 public:
  ...
  Status HandleDAPPLEAllToAll(HloInstruction* crs) override;
  Status HandleCustomCollective(HloInstruction* crs) override;
  Status HandleAllToAll(HloInstruction* hlo) override;
  Status HandleDAPPLEAllGather(HloInstruction* crs) override;
