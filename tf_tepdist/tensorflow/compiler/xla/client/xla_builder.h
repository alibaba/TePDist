...
class XlaBuilder {
 public:
  ...
  StatusOr<XlaComputation> Build(std::map<int, string>& var_map,
 ...
 private:
  ...
  XlaOp DAPPLEAllToAll(XlaOp operand, int64 split_dimension);
  ...
  friend XlaOp DAPPLEAllToAll(XlaOp operand, int64 split_dimension);
