...
// Get GRPC Client.
  static StatusOr<Client*> GetRPCClient(se::Platform* platform = nullptr);
  static StatusOr<Client*> GetRPCClient(se::Platform::Id id);
